...
function App() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center box-border">
      <div className="w-2/3 h-screen flex p-3 gap-3 box-border">
        <ChatList />
            ...
            <div className="flex flex-col h-full overflow-x-auto mb-4">
              <div className="flex flex-col h-full">
                <div className="grid grid-cols-12 gap-y-2" ref={chatBoxRef}>
                  {chatstore[chatstore.current].messages.map(
                    (chat: ChatState) => {
                      return (
                        <div
                          key={chat.id}
