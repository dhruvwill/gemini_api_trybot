        ...
        <div className="md:flex">
          <div className="w-full p-4">
            ...
            <ul className="min-w-48">
              <li
                className={`flex justify-between items-center bg-white ${chatstore.current == "chatgpt" ? "border-gray-900" : ""} border mt-2 p-2 hover:shadow-lg rounded cursor-pointer transition`}
              >
              ...
              <li
                className={`flex justify-between items-center bg-white ${chatstore.current == "gemini" ? "border-gray-900" : ""} border mt-2 p-2 hover:shadow-lg rounded cursor-pointer transition`}
              >
              ...
              <li
                className={`flex justify-between items-center bg-white ${chatstore.current == "claude" ? "border-gray-900" : ""} border mt-2 p-2 hover:shadow-lg rounded cursor-pointer transition`}
              >
                <div className="flex ml-2">
                  {" "}
                  <img
              ...
              <li
                className={`flex justify-between items-center bg-white ${chatstore.current == "llama" ? "border-gray-900" : ""} border mt-2 p-2 hover:shadow-lg rounded cursor-pointer transition`}
              >
                <div className="flex ml-2">
                  {" "}
                  <img
